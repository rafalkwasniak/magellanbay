...
<body class="h-full bg-stone-100 text-stone-800 antialiased">
    ...
    @php
        ...
        $nav = $isAdmin ? [
            ...
            ['label' => 'Katalog', 'route' => 'seller.categories.home', 'active' => 'seller.categories.*', 'icon' => '🗂️', 'section' => 'products'],
            ...
            // Personalizacja i Partnerzy chodzą przy PRODUKTACH, bo to tam się ich
            // używa: opcje wpina się w produkt, licencjodawcę wybiera się przy
            // jego zakładaniu. Rozliczenia to już pieniądze — zostają u właściciela.
            ['label' => 'Personalizacja', 'route' => 'seller.options.index', 'active' => 'seller.options.*', 'icon' => '✍️', 'section' => 'products'],
            ['label' => 'Partnerzy', 'route' => 'seller.licensors.index', 'active' => 'seller.licensors.*', 'icon' => '🤝', 'section' => 'products'],
            ['label' => 'Rozliczenia', 'route' => 'seller.settlements.index', 'active' => 'seller.settlements.*', 'icon' => '🧾', 'owner' => true],
            ...
            //
            // `owner`: rozpatrzenie zgłoszenia to obowiązek prawny prowadzącego
            // sklep (DSA), a nie zadanie do rozdania razem z działem. Gdyby
            // klient chciał inaczej, wystarczy zamienić na 'section' => 'content'.
