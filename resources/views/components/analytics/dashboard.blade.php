...
{{-- Główna kolumna analityki: KPI, ruch, wykres, bestsellery, podziały, klienci.
     JEDEN komponent dla panelu sprzedawcy (jego sklep) i administratora (przekrój
     platformy) — te same liczby liczy ten sam serwis, więc ekrany nie mogą się
     rozjechać. Zakres i filtry zostają w widokach, tu jest tylko prezentacja.
     Osadzany w siatce `lg:grid-cols-12` obok kolumny z filtrami. --}}
    @php
